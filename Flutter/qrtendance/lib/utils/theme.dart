...
TextStyle cardTitleBig = TextStyle(fontFamily: 'Exo_2', fontWeight: FontWeight.w300, fontSize: 28.0, letterSpacing: 5);
...
TextStyle mediumTextStyle = TextStyle(fontFamily: 'VarelaRound', fontSize: 17.0);
...
TextStyle bigTextTitleStyle = TextStyle(color: Colors.white, fontSize: 50.0);
